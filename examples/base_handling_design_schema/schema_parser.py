"""
Core module for parsing and generating robot schemas from natural language instructions.
"""
...
# System prompt for the schema generation
SYSTEM_PROMPT = """
...
def instruction_to_schema(prompt: str) -> str:
    """
    Convert a natural language instruction into a robot schema.

    Args:
        prompt (str): Natural language instruction describing the robot design.

    Returns:
        str: Generated schema in the defined grammar format.
    """
